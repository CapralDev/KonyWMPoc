define({
            ...
            if (TO_ITEM !== undefined) {
                for (i = 0; i < TO_ITEM.length; i++) {
                    if (TO_ITEM[i].TANUM === activeTONumber) {
                        ...
                        // record.imgItemDrawing = {"base64":""};
                        data.push(record);
                    }
                }
                //Get images from SAP
    ...
    onRowClick: function() {
        ...
        activeTOItem.VLENR = selectedRow[0].lblBinNumber;
